...
function CardHeader({ step }: { step: Step }) {
  return (
    <div className="flex flex-col gap-2 border-b border-green-100/80 px-6 pb-5 pt-6">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3">
        <div className="flex flex-col gap-1.5">
          ...
          <input
            ...
            autoComplete="email"
            autoFocus
            className="h-11 w-full rounded-xl border border-green-200 bg-white px-4 text-sm text-green-950 placeholder:text-green-300 outline-none transition focus:border-green-400 focus:ring-2 focus:ring-green-100"
          />
      ...
      <div className="flex gap-2">
        {digits.map((d, i) => (
          <input
            ...
            disabled={loading}
            autoFocus={i === 0}
            className="h-12 w-full rounded-xl border border-green-200 bg-white text-center font-mono text-xl font-semibold text-green-950 outline-none transition focus:border-green-400 focus:ring-2 focus:ring-green-100 disabled:opacity-50"
          />
        ))}
      </div>
